...
if __name__ == '__main__':
    ...
    button_movie = tkinter.Button(root, text='bilibili', command=button)
    button_movie.place(x=325, y=80, width=80, height=40)

    button_movie = tkinter.Button(root, text='播放VIP视频', command=button)
    button_movie.place(x=425, y=80, width=80, height=40)
